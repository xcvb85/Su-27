...
if(variant <= 3) {
    ...
    if(variant <= 2) {
        ...
        pylon03set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
        pylon04set = [pylonSets.empty, pylonSets.R27R, pylonSets.R77];
        pylon05set = [pylonSets.empty, pylonSets.R27R];
        pylon06set = [pylonSets.empty, pylonSets.R27R];
        pylon07set = [pylonSets.empty, pylonSets.R27R, pylonSets.R77];
        pylon08set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
    ...
    fcs = fc.FireControl.new(pylons, [10, 0, 9, 1, 8, 2, 7, 3, 6, 4, 5], ["30mm Cannon", "R-73", "R-77", "R-27T1", "R-27R1"]);
}
else {
    ...
    pylon02set = [pylonSets.empty, pylonSets.R73, pylonSets.R77];
    pylon03set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
    pylon04set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
    pylon05set = [pylonSets.empty, pylonSets.R27R, pylonSets.R77];
    pylon06set = [pylonSets.empty, pylonSets.R27R];
    pylon07set = [pylonSets.empty, pylonSets.R27R];
    pylon08set = [pylonSets.empty, pylonSets.R27R, pylonSets.R77];
    pylon09set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
    pylon10set = [pylonSets.empty, pylonSets.R27T, pylonSets.R27R, pylonSets.R73, pylonSets.R77];
    ...
    pylon01 = stations.Pylon.new("Left wingtip",         0, [3.0,  0.0, 0.0], pylon01set,  0, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[0]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[0]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon02 = stations.Pylon.new("Left wing outboard",   1, [0.0, -2.7, 0.0], pylon02set,  1, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[1]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[1]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon02 = stations.Pylon.new("Left wing center",     2, [0.0, -2.7, 0.0], pylon02set,  2, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[2]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[2]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon03 = stations.Pylon.new("Left wing inboard",    3, [0.0,  2.7, 0.0], pylon03set,  3, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[3]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[3]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon04 = stations.Pylon.new("Left intake",          4, [0.0, -1.7,-1.0], pylon04set,  4, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[4]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[4]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon05 = stations.Pylon.new("Center front",         5, [0.0,  1.7,-1.0], pylon05set,  5, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[5]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[5]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon06 = stations.Pylon.new("Center rear",          6, [0.0,  1.7,-1.0], pylon06set,  6, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[6]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[6]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon07 = stations.Pylon.new("Right intake",         7, [0.0, -1.7,-1.0], pylon07set,  7, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[7]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[7]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon08 = stations.Pylon.new("Right wing inboard",   8, [0.0,  2.7, 0.0], pylon08set,  8, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[8]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[8]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon08 = stations.Pylon.new("Right wing center",    9, [0.0,  2.7, 0.0], pylon08set,  9, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[9]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[9]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon09 = stations.Pylon.new("Right wing outboard", 10, [0.0, -2.7, 0.0], pylon09set, 10, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[10]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[10]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    pylon10 = stations.Pylon.new("Right wingtip",       11, [3.0,  0.0, 0.0], pylon10set, 11, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[11]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[11]",1),func{return getprop("payload/armament/fire-control/serviceable") and 1;},func{return 1;});
    ...
    pylons = [pylon01, pylon02, pylon03, pylon04, pylon05, pylon06, pylon07, pylon08, pylon09, pylon10, pylonI];
    fcs = fc.FireControl.new(pylons, [11, 0, 10, 1, 9, 2, 8, 3, 7, 4, 6, 5], ["30mm Cannon", "R-73", "R-77", "R-27T1", "R-27R1"]);
}
